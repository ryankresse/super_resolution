    ...
    def next(self):
        with self.lock:
            if self.batch_index == 0:
                ...
                #shuffle indices. we'll use this to produce batches
            ...
            #I think we're looping through the batch, pulling one chunk
            #at a time and appending it to an array that will represent
            #our batch
            for i in range(self.chunks_per_batch):    
                #value of where we are in index array
